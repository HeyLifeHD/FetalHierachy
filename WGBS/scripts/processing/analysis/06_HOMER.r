...
#run in command line
cd /omics/groups/OE0219/internal/FetalHierachy/WGBS/210729_analysis/DMRAnal
chmod 777 -R ./
...
do
    echo ${file}
    path=`dirname ${file}`
    findMotifsGenome.pl ${file} hg19 ${path}_customBG -size given -preparsedDir ${path}/ -p 6 -bg /omics/groups/OE0219/internal/FetalHierachy/WGBS/210729_analysis/DMRAnal/homer/DMRs_bg.bed
    echo ${path}
done
